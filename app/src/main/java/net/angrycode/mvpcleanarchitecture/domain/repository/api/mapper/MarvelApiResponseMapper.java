package net.angrycode.mvpcleanarchitecture.domain.repository.api.mapper;
...
import net.angrycode.mvpcleanarchitecture.domain.repository.api.model.Character;
