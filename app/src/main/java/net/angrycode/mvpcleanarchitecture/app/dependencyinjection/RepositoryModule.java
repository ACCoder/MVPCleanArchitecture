...
import net.angrycode.mvpcleanarchitecture.domain.repository.ResponseMapper;
import net.angrycode.mvpcleanarchitecture.domain.repository.api.mapper.MarvelApiResponseMapper;
import net.angrycode.mvpcleanarchitecture.domain.repository.api.retrofit.RetrofitMarvelAPIRepository;
import net.angrycode.mvpcleanarchitecture.domain.repository.api.retrofit.interceptor.MarvelRequestInterceptor;
import net.angrycode.mvpcleanarchitecture.domain.repository.mock.MarvelMockRepository;
